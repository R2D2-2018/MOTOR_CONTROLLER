...
int main() {
    ...
    while (true) {
        ...
        if (interface >= '0' && interface <= numberOfOptions) {
            ...
            motorInterface.setSelectedInterface(static_cast<MotorInterface::INTERFACE>(interface - '0'));
            break;
        }
    }
    ...
    case MotorInterface::INTERFACE::DC:
        hwlib::cout << "DC motor" << hwlib::endl;
        break;
    case MotorInterface::INTERFACE::STEPPER:
